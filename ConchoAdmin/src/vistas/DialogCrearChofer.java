...
public class DialogCrearChofer extends javax.swing.JDialog {
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        String ruta = comboRuta.getSelectedItem().toString();
        String estado = comboEstado.getSelectedItem().toString();
        int id_usuario = idUsuario;
        
        if (nombre.isEmpty() || apellido.isEmpty() || cedula.isEmpty() || telefono.isEmpty() || ruta.isEmpty() || estado.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Debe ingresar todos los datos");
            return;
        }

        Chofer chofer = new Chofer(0, nombre, apellido, estado, Integer.parseInt(ruta), idUsuario, telefono, cedula);
